...
try {
    ...
    // Récupérer les tags pour chaque article
...
<head>
    ...
    <link rel='stylesheet' href='manageArticle.css'>
...
<main>
    <section class='validation'>
        <h1 style='padding-top:150px;'>Gérer les fiches produits</h1>
        ...
        <?php
            ...
            if (!empty($produits)) {
                foreach ($produits as $produit) {
                    ...
                    <form method="POST" action="/criticlick/pannel/manage/action/articleAction.php" style="display:inline;">
                    ...
                    <a href="/criticlick/pannel/manage/modify/modifyArticle.php?id=' . $produit['id'] . '">
